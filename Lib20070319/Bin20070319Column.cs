    ...
    public class Bin20070319Column
    {
        ...
        public Type GetDataType()
        {
            return InternalDataType switch
            {
                ...
                DataType.Value => typeof(string),
                DataType.Value_tbl => typeof(string),
                DataType.Value_idx => typeof(string),
        ...
        public object GetDefaultValue()
        {
            return InternalDataType switch
            {
                ...
                DataType.String_idx => null,
                DataType.Value => string.Empty,
                DataType.Value_tbl => string.Empty,
